...
Func DropTroopFromINI($sDropVectors, $iStartIndex, $iEndIndex, $aiIndexArray, $iMinQuantity, $iMaxQuantity, $sTroopName, $delayPointmin, $delayPointmax, $delayDropMin, $delayDropMax, $sleepafterMin, $sleepAfterMax, $bDebug = False)
	...
	Switch $iTroopIndex
		...
		Case $eKing, $eQueen, $eWarden, $eChampion, $eDragonDuke, $eCastle, $eWallW, $eBattleB, $eStoneS, $eSiegeB, $eLogL, $eFlameF, $eBattleD
				...
				If $index <= UBound(Execute("$" & Eval("vector" & $j))) Then
					...
					Switch $iTroopIndex
						...
						Case $eDragonDuke
							...
							Else
								dropHeroes($pixel[0], $pixel[1], -1, -1, -1, -1, -1, $troopPosition) ; was $g_iDragonDukeSlot, Slot11+
							EndIf
